...
func TestNoArgumentCommand(t *testing.T) {
	os.Args = []string{"./csv2json"} // mock CLI for unit test
...
func TestMultiAugumentCommand(t *testing.T) {
	os.Args = []string{"./csv2json", "csv/input.csv", "yeeeee"} // mock CLI for unit test
...
func TestWrongFormatCommand(t *testing.T) {
	os.Args = []string{"./csv2json", "-f", "yaml", "csv/input.csv"} // mock CLI for unit test
